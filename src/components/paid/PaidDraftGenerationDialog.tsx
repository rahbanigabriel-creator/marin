  ...
  return (
    ...
    >
        ...
        <div className="px-[16px] py-[15px]">
          <p id={descriptionId} className="m-0 text-[12px] leading-[1.55] text-ink-500">Marpin uses your saved audit context, eligible workspace assets, and your instruction to create a saved draft. It consumes AI credits, creates no provider campaign, and spends no budget.</p>
